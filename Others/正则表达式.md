...
![regexp-en](/F:/Pictures/regexp-en.png)
 ...
 * [1. 基本匹配](正则表达式.md#1-基本匹配)
 * [2. 元字符](正则表达式.md#2-元字符)
 	* [2.1 点运算符 .](正则表达式.md#21-点运算符-)
 	* [2.2 字符集](正则表达式.md#22-字符集)
		* [2.2.1 否定字符集](正则表达式.md#221-否定字符集)
	* [2.3 重复次数](正则表达式.md#23-重复次数)
		* [2.3.1 \* 号](正则表达式.md#231--号)
		* [2.3.2 + 号](正则表达式.md#232--号)
		* [2.3.3 ? 号](正则表达式.md#233--号)
	* [2.4 {} 号](正则表达式.md#24--号)
	* [2.5 (...) 特征标群](正则表达式.md#25--特征标群)
	* [2.6 | 或运算符](正则表达式.md#26--或运算符)
	* [2.7 转码特殊字符](正则表达式.md#27-转码特殊字符)
	* [2.8 锚点](正则表达式.md#28-锚点)
		* [2.8.1 ^ 号](正则表达式.md#281--号)
		* [2.8.2 \$ 号](正则表达式.md#282--号)
* [3. 简写字符集](正则表达式.md#3-简写字符集)
* [4. 零宽度断言(前后预查)](正则表达式.md#4-零宽度断言前后预查)
	* [4.1 ?\=... 正先行断言](正则表达式.md#41--正先行断言)
	* [4.2 ?!... 负先行断言](正则表达式.md#42--负先行断言)
	* [4.3 ?&lt;\= ... 正后发断言](正则表达式.md#43---正后发断言)
	* [4.4 ?&lt;!... 负后发断言](正则表达式.md#44--负后发断言)
* [5. 标志](正则表达式.md#5-标志)
	* [5.1 忽略大小写（Case Insensitive）](正则表达式.md#51-忽略大小写-case-insensitive)
	* [5.2 全局搜索（Global search）](正则表达式.md#52-全局搜索-global-search)
	* [5.3 多行修饰符（Multiline）](正则表达式.md#53-多行修饰符-multiline)
* [额外补充](正则表达式.md#额外补充)
* [贡献](正则表达式.md#贡献)
* [许可证](正则表达式.md#许可证)
