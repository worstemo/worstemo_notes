...
# [Markdown+Typora/VSCode 超全教程] 给大学生安利的文本神器

Sakiyary 2022/7/16

## 😂 简要介绍

**Markdown** 是一种轻量型标记语言, 是一*种语法. 以 `.md` 结尾的文本文件就是 Markdown 文件. 相较于 **Word**, 它更加像是 **HTML** 语言或是 $\LaTeX$, 并不是最淳朴的那种"所见即所得". 它处处透露着一种极简主义. 高效简洁清晰的同时, 又很简单. 看起来舒服, 语法简单, 尤其在处理纯文本上有很大的优势. 
